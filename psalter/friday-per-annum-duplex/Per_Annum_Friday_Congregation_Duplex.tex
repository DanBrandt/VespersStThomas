...
\chapter*{Vespers on Friday\\ for Duplex Feasts}
...
{\color{red}\textbf{All stand}, and the cantor intones the antiphon to the first asterisk, then all join in, completing the remainder, sitting afterwards. The cantor then stands alone to intone the first half of the first Psalm verse.}
...
{\color{red}The choir sits and the cantor remains standing until the asterisk.}
