...
\textit{\textnormal{Ant. 4.} Lord\dots \textnormal{Ps.} I have cried to Thee, O Lord: hear me: hearken to my voice, when I cry to Thee.}
...
\begin{latinenglishsection}
 ...
 \latinenglish{
	...
	11. Cadent in retiáculo ejus\\ pecca\textbf{tó}res:~* {\color{red}\textit{(stand)}} singuláriter sum ego \textit{do}\textit{nec} \textbf{tráns}eam.
 }{
...
12. {\color{red}\textit{(bow)}} Glória Patri, et \textbf{Fí}lio,~* et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.
	
13. {\color{red}\textit{(rise)}} Sicut erat in princípio, et nunc, et \textbf{sem}per,~* et in s\'{\ae}cula sæcu\textit{ló}\textit{rum}. \textbf{A}men.
 
 %\vfill\pagebreak

\gresetinitiallines{0}
\gregorioscore{ps141-antiphon}
\textit{\textnormal{Ant.} Lord, I have cried to Thee, hear me.}

\section*{Psalm 141}

\textit{\textnormal{Ant. 5.} The portion\dots \textnormal{Ps.} I cried to the Lord with my voice: with my voice I made supplication to the Lord.}
...
\latinenglish{
	...
	7. Clamávi ad te, Dómine,~{\color{red}\GreDagger}\ dixi: Tu es spes \textbf{me}a,~* pórtio mea in ter\textit{ra} \textit{vi}\textbf{vén}tium.
	...
	10. Educ de custódia ánimam meam ad confiténdum nómini \textbf{tu}o:~* {\color{red}\textit{(stand)}} me exspéctant justi, donec retrí\textit{bu}\textit{as} \textbf{mi}hi.
...
\gresetinitiallines{0}
\gregorioscore{ps141-antiphon}
\textit{\textnormal{Ant.} The portion of my Lord is in the land of the living.}

\begin{rubricbox}

{\color{red}Continue on to the insert for the day, containing the Hymn, Magnificat, Collect, Commemorations if any are present, and Conclusion.}
