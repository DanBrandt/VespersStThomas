...
{\color{red}All \textbf{stand}. The Cantor intones the antiphon and leads the Psalm through the first verse, then all \textbf{sit}.}
...
{\color{red}All \textbf{remain standing}. The Cantor intones the antiphon and leads the Psalm through the first verse, then all \textbf{sit}.}
...
%	9. Non fecit táliter omni \textbf{na}ti\textbf{ó}ni:~* {\color{red}\textit{(color)}}
%		et judícia sua non manifes\textit{tá}\textit{vit} \textbf{e}is.
...
%{\color{red}All \textbf{stand} as the Officiant chants:}
...
%{\color{red}The Cantor leads the hymn:}
...
%{\color{red}The Cantor says the following:}
...
%\begin{rubricbox}
%Then follows the seasonal Marian anthem, found in the \textit{Traditional Roman Hymnal}
