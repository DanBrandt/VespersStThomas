...
4. Quia fecit mihi \textit{ma}\textit{gna} \textit{qui} \textbf{pot}ens est:~* 
	et sanc\textit{tum} \textit{no}\textit{men} \textbf{e}jus.

5. Et misericórdia ejus a progéni\textit{e} \textit{in} \textit{pro}\textbf{gé}nies~* 
...
{\color{red}\textit{(bow)}} Glória \textit{Pa}\textit{tri}, \textit{et} \textbf{Fí}lio,~* 
...
\latinenglish{
	...
	Orémus.
	Concéde nos fámulos tuos, qu\'{\ae}sumus, Dómine Deus,{\color{red}\GreDagger} perpétua mentis et córporis sanitáte gaudére: et, gloriósa beátæ Maríæ semper Vírginis intercessióne, a\\ præsénti liberári tristítia, et ætérna pérfrui lætítia.
