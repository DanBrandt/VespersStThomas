...
{\color{red}At Solemn Vespers, the Celebrant, led by the servers, processes into the Sanctuary. The acolytes proceed to either side of the altar. After the Celebrant arrives to the Predella, he removes his biretta, kneels and silently prays the \textit{Aperi, Dómine} (Open, O Lord, my mouth to bless Thy Holy Name...). The acolytes set their candles down, and all join the Celebrant in kneeling and praying silently.\\
...
\begin{rubricbox}
{\color{red} Before the `Gloria Patri' doxology of this final Psalm, the acolytes go and light their candles, take them up, and stand on either side of the Celebrant.}
\end{rubricbox}
...
{\color{red}A Cantor again pre-intones the Magnificat antiphon for the Celebrant. The Celebrant then intones up to the asterisk, after which all \textbf{sit} and join in singing. The Celebrant dons his biretta. He and the Thurifer and MC then incense the altar as at Mass. The Thurifer then incenses the servers and the congregation. To ensure the Gloria Patri is not said before the incensation is complete, the Antiphon may be inserted between a pair of verses of the Magnificat.}
...
{\color{red}\textbf{All sit}, the Celebrant dons his biretta, and all repeat the antiphon: \textit{Ignem\dots}}
...
\textit{\color{red} The Celebrant removes his biretta and gives it to the MC. \textbf{All stand.} The Celebrant leads the collect:}
...
\textit{\color{red}The Celebrant leads the Benedicamus and reply with `Deo grátias':}
...
{\color{red} The Office is thus concluded. The \textit{Pater Noster} may be said silently, after which the Celebrant dons his biretta and the servers process out of the sanctuary. After the Office, all \textbf{kneel} and pray in silence for a time.}
