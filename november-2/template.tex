...
%% NOTE: most years the Second Sunday of November is skipped and you go straight from the 1st to the 3rd.
%%  Check the ordo to make sure you're really supposed to be using this sheet

%% TODO: correct date
\chapter*{Vespers Insert for Saturday, ??DATE??}

%% TODO: correct intro
 \textit{Vespers today is based on the following Sunday, which is the Second of November and the ??Nth?? after Pentecost. All is said as in the main booklet until the Magnificat.}
...
\textit{\textnormal{Ant.} See, O Lord, how the city full of wealth is become desolate: the ruler of the nations sitteth in grief:
there is none to comfort her, except Thou, our God.}
