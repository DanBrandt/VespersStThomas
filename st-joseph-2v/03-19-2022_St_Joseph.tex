...
8. De torrénte in \textbf{vi}a \textbf{bi}bet:~* \textit{\color{red}(stand)}
	proptérea exal\textit{tá}\textit{bit} \textbf{ca}put.

\textit{\color{red}(bow)} Glória \textbf{Pa}tri, et \textbf{Fí}lio,~*
	et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.

\textit{\color{red}(rise)} Sicut erat in princípio, et \textbf{nunc}, et \textbf{sem}per,~*
	et in s\'{\ae}cula sæcu\textit{ló}\textit{rum}. \textbf{A}men.

\begin{rubricbox}

{\color{red}The antiphon is repeated: \textit{Ibant\dots}}
...
10. Intelléctus bonus ómnibus faciéntibus \textbf{e}um:~* \textit{\color{red}(stand)} laudátio ejus manet in s\'{\ae}cu\textit{lum} \textbf{s\'{\ae}}culi.

\textit{\color{red}(bow)} Glória Patri, et \textbf{Fí}lio,~* et Spirítu\textit{i} \textbf{Sanc}to.

\textit{\color{red}(rise)} Sicut erat in princípio, et nunc, et \textbf{sem}per,~* et in s\'{\ae}cula sæculó\textit{rum}. \textbf{A}men.

\begin{rubricbox}

{\color{red}The antiphon is repeated: \textit{Cum redirent\dots}}
...
8. Dispérsit, dedit paupéribus:~\GreDagger\ justítia ejus manet in \textbf{s\'{\ae}}culum \textbf{s\'{\ae}}\-\textbf{cu}li,~* \textit{\color{red}(stand)} cornu ejus exaltábi\textbf{tur} in \textbf{gló}ria.

\textit{\color{red}(bow)} Glória \textbf{Pa}tri, et \textbf{Fí}\textbf{li}o,~* et Spi\textbf{rí}tui \textbf{Sanc}to.

\textit{\color{red}(rise)} Sicut erat in princípio, et \textbf{nunc}, et \textbf{sem}per,~* et in s\'{\ae}cula sæcu\textbf{ló}rum. \textbf{A}men.
}{
...
{\color{red}The antiphon is repeated: \textit{Non invenientes\dots}}
...
2. Sit nomen Dómini \textit{be}\textit{ne}\-\textbf{díc}tum,~* ex hoc nunc, et \textit{us}\textit{que} \textit{in} \textbf{s\'{\ae}}\textbf{cu}lum.
...
8. Qui habitáre facit stéri\textit{lem} \textit{in} \textbf{do}mo,~* \textit{\color{red}(stand)} matrem fili\textit{ó}\textit{rum} \textit{læ}\textbf{tán}tem.
...
{\color{red}The antiphon is repeated: \textit{Dixit Mater ejus ad illum\dots}}
...
2. Quóniam confirmáta est super nos misericórdia \textbf{e}jus:~*
	\textit{\color{red}(stand)} et véritas Dómini manet \textit{in} \textit{æ}\textbf{tér}num.
...
{\color{red}The antiphon is repeated: \textit{Descendit\dots}}
...
\textit{\color{red}(bow)} \textit{Glóri}a Patri, et \textbf{Fí}lio,~* 
	et Spirí\textit{tu}\textit{i} \textbf{Sanc}to.

\textit{\color{red}(rise)} \textit{Sicut} erat in princípio, et nunc, et \textbf{sem}per,~*
	et in s\'{\ae}cula sæcu\textit{ló}\textit{rum}. \textbf{A}men.

\begin{rubricbox}

{\color{red}All \textbf{sit} and repeat the antiphon: \textit{Non turbetur\dots},
...
\latinenglish{
	...
	Who livest and reignest with the Father in the unity of the Holy Ghost, God, world without end.
	\Rbar.~Amen.
}
\end{latinenglishsection}
...
\textit{\color{red}The Officiant leads the following responsorial prayers:}
...
\textit{\color{red}The Cantor leads the Marian Anthem and responsorial prayers afterwards, while the Officiant leads the ending collect:}
