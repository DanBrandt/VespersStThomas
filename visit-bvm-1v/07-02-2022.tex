...
The antiphon is repeated: \textit{Exsúrgens María\dots}, then all \textbf{stand}.
...
The antiphon is repeated: \textit{Intrávit María\dots}, then all \textbf{stand}.
...
The antiphon is repeated: \textit{Benedícta\dots}, then all \textbf{stand}.
...
The antiphon is repeated: \textit{Ex quo facta est\dots}, then all \textbf{stand}.
...
\latinenglish{
	Ab inítio et ante sǽcula creáta sum\greheightstar\,
	et usque ad futúrum sǽculum \textit{non dési}nam, et in habitatióne sancta coram ipso ministrávi.
	\Rbar.~Deo grátias.
}{
...
All \textbf{sit} and repeat the antiphon: \textit{Beátam me dicent\dots},
