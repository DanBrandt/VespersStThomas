...
\gresetinitiallines{0}
\gabcsnippet{
(c3) <sp>R/</sp>. Lau(h)dé(h)mus(h) et(h) su(h)pe(h)rex(h)al(h)té(h)mus(h) eum(h) in(h) sæ(h)cu(f)la(f.). (::)
}
...
\latinenglish{
	...
	Orémus.
	Omnípotens sempitérne Deus, qui dedísti fámulis tuis in confessióne veræ fídei, ætérnæ Trinitátis glóriam agnóscere, et in poténtia majestátis adoráre Unitátem: qu\'{\ae}sumus; ut, ejúsdem fídei firmitáte, ab ómnibus semper muniámur advérsis.
