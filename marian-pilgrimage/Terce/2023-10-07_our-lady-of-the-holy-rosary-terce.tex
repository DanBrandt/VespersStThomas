...
\latinenglish{
	...
	\input{../../psalms/ps118-3-4A} %% 

}{
	\input{../../psalms/english/ps118-3} %%
}
...
\latinenglish{
	...
	\input{../../psalms/ps118-4-4A} %% 

}{
	\input{../../psalms/english/ps118-4} %%
}
...
\latinenglish{
	...
	\input{../../psalms/ps118-5-4A} %% 

}{
	\input{../../psalms/english/ps118-5} %%
}
...
\gresetinitiallines{0}
\gabcsnippet{(c3) <c><sp>V/</sp>.</c> Post(h) par(h)tum(h) Vir(h)go(h) in(h)vi(h)o(h)lá(h)ta(h) per(h)man(h)sís(h)ti.(g'_/hvGF'E/fgf.) (::)}

\gresetinitiallines{0}
\gabcsnippet{(c3) <c><sp>R/</sp>.</c> De(h)i(h) Gé(h)ni(h)trix(h) in(h)ter(h)cé(h)de(h) pro(h) no(h)bis.(g'_/hvGF'E/fgf.) (::)}
