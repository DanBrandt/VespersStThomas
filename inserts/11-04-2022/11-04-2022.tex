...
\chapter*{Vespers Insert for Friday, November 4, 2022}
 ...
 \textit{Vespers today is that of St. Charles Borromeo, of double rank.
...
\latinenglish{
	...
	Orémus.
	Ecclésiam tuam, Dómine, sancti Cároli Confessóris tui atque Pontíficis contínua protectióne custódi: {\color{red}\GreDagger}\ ut, sicut illum pastorális sollicitúdo glori\textbf{ó}\textit{sum réd}\textbf{di}dit; ita nos ejus intercéssio in tuo semper fáciat amóre fervéntes. *
...
\latinenglish{
	...
	Orémus.
	Omnípotens sempitérne Deus, qui nos ómnium Sanctórum tuórum mérita sub una tribuísti celebritáte venerári: {\color{red}\GreDagger}\ qu\'{\ae}sumus; ut desiderátam nobis tuæ propitiati\textbf{ó}\textit{nis a}\textbf{bun}dántiam, multiplicátis\\ intercessóribus, largiáris. *
	Per Dóminum nostrum Jesum Christum, Fílium tuum: qui tecum vivit et regnat in unitáte Spíritus Sancti, Deus, per ómnia s\'{\ae}cula sæculórum.\\
	{\color{red}\Rbar.}~Amen.
}{
