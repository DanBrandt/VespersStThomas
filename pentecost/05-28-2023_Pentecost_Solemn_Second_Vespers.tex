...
\gresetinitiallines{1}
\gregorioscore{ps109-antiphon-only}
...
\gresetinitiallines{1}
\gregorioscore{ps110-antiphon-only}
...
\gresetinitiallines{1}
\gregorioscore{ps111-antiphon-only}
...
\gresetinitiallines{1}
\gregorioscore{ps113-antiphon-only}
...
\latinenglish{
	 ...
	 et factus est repénte de c{\oe}lo sonus, tamquam adveniéntis spíritus veheméntis:~{\color{red}*}
...
\gabcsnippet{
(c3) <c><sp>V/</sp>.</c> Lo(h)que(h)bán(h)tur(h) vá(h)ri(h)is(h) lin(h)guis(h) A(h)pó(h)sto(h)li(h) (,)
al(h)le(fe)lú(f_h)ia.(hiH'Ghih.ghG'FE'fggf.) (::)
}

\gresetinitiallines{0}
\gabcsnippet{
(c3) <c><sp>R/</sp>.</c> Ma(h)gná(h)li(h)a(h) De(h)i(h) (,) al(h)le(fe)lú(f_h)ia.(hiH'Ghih.ghG'FE'fggf.)(::)
}
...
{\color{red}All \textbf{sit} and repeat the antiphon: \textit{Hódie compléti sunt\dots},
...
\textit{\color{red}The Celebrant leads the collect:}
