...
{\color{red} The remaining Psalms are said in the same manner as the first, except that the cantor alone stands when intoning both the antiphon and the Psalm verse.}
...
{\color{red}The Cantor intones the antiphon and first verse; all make the Sign of the Cross at the word `Magnificat'.}
...
\textit{\color{red}The Officiant leads the Benedicamus:}
