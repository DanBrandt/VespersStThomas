...
9. Peccátor vidébit, et irascétur,~{\color{red}\GreDagger}\ déntibus suis fremet \textbf{et} ta\textbf{bé}scet:~* {\color{red}\textit{(stand)}} desidérium peccató\textit{rum}\\ \textit{per}\textbf{í}bit.
