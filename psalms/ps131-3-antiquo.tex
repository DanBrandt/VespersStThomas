2. Sicut ju\textbf{rá}vit Dó\textbf{mi}no,~* votum vovit \textbf{De}o \textbf{Ja}cob:
...
5. Et réquiem tempóribus meis: donec invéniam \textbf{lo}cum Dó\textbf{mi}no,~* tabernáculum \textbf{De}o \textbf{Ja}cob.

6. Ecce audívimus \textbf{e}am in E\textbf{phra}ta:~* invénimus eam in \textbf{cam}pis \textbf{sil}væ.
...
9. Sacerdótes tui indu\textbf{án}tur justí\textbf{ti}am:~* et sancti \textbf{tu}i ex\textbf{súl}tent.
...
13. Et fílii eórum \textbf{us}que in \textbf{s\'{\ae}}\textbf{cu}lum:~* sedébunt super \textbf{se}dem \textbf{tu}am.

14. Quóniam elégit \textbf{Dó}minus \textbf{Si}on:~* elégit eam in habitati\textbf{ó}nem \textbf{si}bi.

15. Hæc réquies mea in \textbf{s\'{\ae}}culum \textbf{s\'{\ae}}\textbf{cu}li:~* hic habitábo, quóniam e\textbf{lé}gi \textbf{e}am.
...
20.{\color{red}\textit{(bow)}} Glória \textbf{Pa}tri, et Fí\textbf{li}o,~* et Spi\textbf{rí}tui \textbf{Sanc}to.

21.{\color{red}\textit{(rise)}} Sicut erat in princípio, et \textbf{nunc}, et \textbf{sem}per,~* et in s\'{\ae}cula sæcu\textbf{ló}rum. \textbf{A}men.
