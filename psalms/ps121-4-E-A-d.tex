2. Stantes erant \textit{pe}\textit{des} \textbf{nos}tri,~* in átriis \textit{tu}\textit{is}, \textit{Je}\textbf{rú}\textbf{sa}lem.
...
9. Propter domum Dómini, \textit{De}\textit{i} \textbf{nos}tri,~* {\color{red}\textit{(stand)}} quæsí\textit{vi} \textit{bo}\textit{na} \textbf{ti}bi.
